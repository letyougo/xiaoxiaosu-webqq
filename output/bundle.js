...
/***/ function(module, exports, __webpack_require__) {
	...
	var MainPanel = __webpack_require__(164);

	window.root={
	    setBoxBehavior:function(obj){
	        var $this = $(ReactDOM.findDOMNode(obj)),
	            $head = $this.find(".side-head"),
	            $left = $this.find(".side-left"),
	            $right = $this.find(".side-right"),
	            $top =$this.find(".side-top"),
	            $bottom = $this.find(".side-bottom");

	        $head.on("mousedown",function(e){
	            var offSet = $this.offset(),
	                offsetLeft = offSet.left*1 - e.pageX*1,
	                offsetTop = offSet.top*1 - e.pageY*1;

	            $(document).on("mousemove",function(e){

	                $this.css({
	                    left :e.pageX*1 + offsetLeft*1 + "px",
	                    top : e.pageY*1 + offsetTop*1 + "px"
	                });
	        ...
	        //        $this.css({
	        //            left :e.pageX*1 + "px",
	        //            width : width*1 + offsetLeft*1 - e.pageX*1 + "px"
	        //        });
	        //    });
	        //    $(document).on("mouseup",function(){
	        //        $(document).off("mousemove");
	        ...
	        //    var offSet = $this.offset(),
	        //        offsetRight = offSet.left + $this.width(),
	        //        width = $this.width();
	        //
	        //
	        //    $(document).on("mousemove",function(e){
	        ...
	        //        }
	        //        $this.css({
	        //            width :width*1 + e.pageX*1 - offsetRight*1 + "px"
	        //        });
	        //    });
	        //    $(document).on("mouseup",function(){
	        //        $(document).off("mousemove");
	        ...
	        //        $this.css({
	        //            top :e.pageY*1 + "px",
	        //            height : height*1 + offsetTop*1 - e.pageY*1 + "px"
	        //        });
	        //    });
	        //    $(document).on("mouseup",function(){
	        //        $(document).off("mousemove");
	        ...
	        //    var offSet = $this.offset(),
	        //        offsetBottom = offSet.top + $this.height(),
	        //        width = $this.height();
	        //
	        //    $(document).on("mousemove",function(e){
	        //
	        //        $this.css({
	        //            height :width*1 + e.pageY*1 - offsetBottom*1 + "px"
	        //        });
	        //    });
	        //    $(document).on("mouseup",function(){
	        //        $(document).off("mousemove");
	...
	ReactDOM.render(React.createElement(MainPanel, null),document.getElementById("root"));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MainPanelBody = __webpack_require__(167);
	    ...
	    render:function(){
	        return (
	            React.createElement("div", {className: "main-panel"}, 
	                React.createElement(MainPanelHead, null), 
	                React.createElement(MainPanelBody, null), 
	                React.createElement(MainPanelFoot, null)
	            )
	        )
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/less-loader/index.js!./main-panel.less", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/less-loader/index.js!./main-panel.less");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var User = __webpack_require__(170),
	    Group = __webpack_require__(171),
	    Recent = __webpack_require__(172);
	    ...
	    render:function(){
	        return (
	            React.createElement("div", {className: "search"}, 
	                React.createElement("input", {className: "input input-group", placeholder: "搜索人员，群组，最近联系人"}), 
	                React.createElement("div", {className: "fa fa-close fa-lg close"})
	            )
	        )
	    }
	})
	        ...
	        return (
	            React.createElement("div", {className: "main-panel-body"}, 
	                ...
	                React.createElement("div", {className: "title"}, 
	                    React.createElement("span", {className: "fa fa-user user", onClick: this.shiftModule.bind(this,0)}), 
	                    React.createElement("span", {className: "fa fa-group group", onClick: this.shiftModule.bind(this,1)}), 
	                    React.createElement("span", {className: "fa fa-comment recent", onClick: this.shiftModule.bind(this,2)})
	                ), 
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/less-loader/index.js!./body.less", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/less-loader/index.js!./body.less");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
	...
	var User = React.createClass({displayName: "User",
	    ...
	    getInitialState:function(){
	        return {
	            ...
	            //users:[
	            //    [{"name":"xiaoxiaosu"},{name:"hello"},{name:"world"}],
	            //    [{"name":"xiaoxiaosu"},{name:"hello"},{name:"world"}],
	            //    [{"name":"xiaoxiaosu"},{name:"hello"},{name:"world"}],
	            //    [{"name":"xiaoxiaosu"},{name:"hello"},{name:"world"}],
	            //    [{"name":"xiaoxiaosu"},{name:"hello"},{name:"world"}]
	    ...
	    render:function(){
	        var that = this,
	            getList=function(users){
	                console.log(users)
	                return users.map(function(u){
	                    return (
	                        React.createElement("li", {onClick: that.pick}, u.name)
	                    )
	                })
	            };
	        var nodes = this.state.groups.map(function(g,i){
	            return (
	                React.createElement("div", null, 
	                    React.createElement("p", null, React.createElement("i", {className: "fa fa-caret-right", onClick: that.loadUserGroup.bind(that,g.id)}), " ", g.name), 
	        ...
	        return (
	            React.createElement("div", {className: "user"}, 
	                nodes, 
	                React.createElement("div", {className: "fa fa-plus-circle fa-2x add-group"})
	            )
	        )
	    },
	    ...
	    pick:function(e){
	        ...
	        this.picked = $(e.target ).addClass("active")
	    },
	    loadUserGroup:function(id,e){
